...
<div class="ui bottom attached active tab segment input-field-container" data-tab="textarea">
  ...
  <div class="field">
	...
	<textarea class="template mceEditor textarea input-field change-event" id="template" name="template" onfocus="this.select()"><p>[[IMG </p>

<p>這是巨量資料探勘與統計應用課程的投影片「<a href="{LINK}" target="google-drive">{CHI}</a>」。本單元是屬於系列課程中的「[[???]]」，處理資料類型包括了「類別」跟「連續」兩種。[[abs]]。</p>
<p>這個單元包含了四個實作學習單跟一份測驗，供同學邊看邊練習。</p>
<!-- more -->
<hr />
...
<ul>
	<li>
		教學投影片：
		<a href="{google_presentation}" target="google_presentation">Google Presentation</a>
	</li>
	<li>
		教學投影片其他格式：
		<a href="{fdf2}" target="GoogleDrive_download">Power Point</a>、
		<a href="{fdf2_pdf}" target="GoogleDrive_download">PDF</a>、
		<a href="{fdf2_odp}" target="GoogleDrive_download">OpenDocument Presnetation</a>
	</li>
</ul>
<p>我以Google簡報的檔案匯出成PPTX，再備份到以下位置：</p>
<ul>
	<li>
            <a href="{fdf7}" target="SlideShare_download">SlideShare</a>
            、
            <a href="{fdf1}" target="GitHub_download">GitHub</a>
            、
            <a href="{fdf3}" target="OneDrive_download">OneDrive</a>
            、
            <a href="{fdf4}" target="Box_download">Box</a>
            、
            <a href="{fdf5}" target="Mega_download">Mega</a>
            、
            <a href="{fdf6}" target="MediaFire_download">MediaFire</a>
            、
            <a href="{fdf8}" target="GoogleDrive_download">Google Drive</a>
	</li>
</ul>

<h4>結論寫作框架 / Result Framework</h4>

<p>請參考以下結論框架，將底線的文字改為合適的內容，完成皮爾森積差相關分析的結論吧。</p>

<table border="1"><tbody>     <tr>       <td style="background-color: rgb(40, 158, 69);"><strong><span style="color: rgb(255, 255, 255);">研究目的</span></strong></td>     </tr>      <tr>       <td><span style="font-weight: 400;">本研究使用積差相關分析來分析<span style="text-decoration: underline;">(檢定變項1)</span>、<span style="text-decoration: underline;">(檢定變項2)</span>與<span style="text-decoration: underline;">(檢定變項3)</span>兩兩變項之間是否有線性相關。</span></td>     </tr>      <tr>       <td style="background-color: rgb(40, 158, 69);"><span style="color: rgb(255, 255, 255);"><strong>樣本敘述統計量</strong></span></td>     </tr>      <tr>       <td style="text-align: left;">         <div align="center"><u>(每一個檢定變項重複描述)</u></div>          <div><u>(檢定變項)</u>的平均數為<u>(平均數</u>)，標準差為<u>(標準差</u>)，樣本數為<u>(樣本數)</u>。</div>       </td>     </tr>      <tr>       <td style="background-color: rgb(40, 158, 69);"><span style="color: rgb(255, 255, 255); font-weight: 400;">相關分析</span></td>     </tr>      <tr>       <td>         <table border="1"><tbody>             <tr>               <td style="background-color: rgb(11, 84, 17);"><span style="color: rgb(255, 255, 255);"><strong><b>說明高度/中度相關，且達到顯著水準的變項組合：</b></strong></span></td>             </tr>              <tr>               <td>                 <p align="center"><u>(每一個符合的檢定變項組合重複描述)</u></p>                  <p>相關分析結果顯示，<u>(檢定變項X)</u>與<u>(檢定變項Y)</u>的相關係數為<u>(X跟Y的相關係數)</u>，達到<u>(X跟Y相關係數的顯著水準)</u>的顯著水準，二者有顯著的<u>(X跟Y的關聯程度與方向)</u>。</p>                  <p>表示<u>(檢定變項X)</u>越高者，<u>(檢定變項Y)</u>也會越高。</p>                  <p>變項間的決定係數r<sup>2</sup>為<u>(X跟Y的決定係數)</u>，表示兩變項可解釋對方的變異量為<u>(X跟Y的決定係數百分比)</u>%。</p>               </td>             </tr>              <tr>               <td style="background-color: rgb(11, 84, 17);"><span style="color: rgb(255, 255, 255);"><span style="font-weight: 400;"><b>說明高度/中度相關，但未達顯著水準的變項組合：</b></span></span></td>             </tr>              <tr>               <td>                 <p align="center"><u>(每一個符合的檢定變項組合重複描述)</u></p>                  <p>此外，<u>(檢定變項X)</u>與<u>(檢定變項Y)</u>的相關係數為<u>(X跟Y的相關係數)</u>，二者之間有<u>(X跟Y的關聯程度與方向)</u>。</p>                  <p>但是相關係數未達0.05顯著水準，僅可供實務意義上參考使用。</p>               </td>             </tr>              <tr>               <td style="background-color: rgb(11, 84, 17);"><span style="color: rgb(255, 255, 255);"><span style="font-weight: 400;"><b>說明低度或無相關的變項組合：</b></span></span></td>             </tr>              <tr>               <td>                 <p align="center"><u>(每一個符合的檢定變項組合重複描述)</u></p>                  <p>最後，<u>(檢定變項X)</u>與<u>(檢定變項Y)</u>的相關係數為<u>(X跟Y的相關係數)</u>，二者為<u>(低度或無相關)</u>。表示兩兩變項之間沒有明顯的線性相關。</p>               </td>             </tr>           </tbody></table>       </td>     </tr>   </tbody></table>

<p>舉例來說，像是：</p>

<table border="1"><tbody>     <tr>       <td style="background-color: rgb(40, 158, 69);"><strong><span style="color: rgb(255, 255, 255);">研究目的</span></strong></td>     </tr>      <tr>       <td><span style="font-weight: 400;">本研究使用積差相關分析來分析<span style="text-decoration: underline;">數理能力</span>、<span style="text-decoration: underline;">美術能力</span>與<span style="text-decoration: underline;">比賽總成績</span>兩兩變項之間是否有線性相關。</span></td>     </tr>      <tr>       <td style="background-color: rgb(40, 158, 69);"><span style="color: rgb(255, 255, 255);"><strong>樣本敘述統計量</strong></span></td>     </tr>      <tr>       <td style="text-align: left;">         <div><span style="text-decoration: underline;">數理能力</span>的平均數為<u>65.100</u>，標準差為<u>18.873</u>，樣本數為<u>60份</u>。</div>          <div><span style="text-decoration: underline;">美術能力</span>的平均數為<u>70.100</u>，標準差為<u>12.233</u>，樣本數為<u>60份</u>。</div>          <div><span style="text-decoration: underline;">比賽總成績</span>的平均數為<u>54.100</u>，標準差為<u>16.103</u>，樣本數為<u>60份</u>。</div>       </td>     </tr>      <tr>       <td style="background-color: rgb(40, 158, 69);"><span style="color: rgb(255, 255, 255); font-weight: 400;">相關分析</span></td>     </tr>      <tr>       <td>         <table border="1"><tbody>             <tr>               <td style="background-color: rgb(11, 84, 17);"><span style="color: rgb(255, 255, 255);"><strong><b>說明高度/中度相關，且達到顯著水準的變項組合：</b></strong></span></td>             </tr>              <tr>               <td>                 <p>相關分析結果顯示，<u>數理能力</u>與<u>比賽總成績</u>的相關係數為<u>0.776</u>，達到<u>0.001</u>的顯著水準，二者有顯著的<u>高度正相關</u>。</p>                  <p>表示<u>數理能力</u>越高者，<u>比賽總成績</u>也會越高。</p>                  <p>變項間的決定係數r<sup>2</sup>為<u>0.603</u>，表示兩變項可解釋對方的變異量為<u>60.3%</u>。</p>               </td>             </tr>              <tr>               <td style="background-color: rgb(11, 84, 17);"><span style="color: rgb(255, 255, 255);"><span style="font-weight: 400;"><b>說明高度/中度相關，但未達顯著水準的變項組合：</b></span></span></td>             </tr>              <tr>               <td>(沒有符合的項目，略過)</td>             </tr>              <tr>               <td style="background-color: rgb(11, 84, 17);"><span style="color: rgb(255, 255, 255);"><span style="font-weight: 400;"><b>說明低度或無相關的變項組合：</b></span></span></td>             </tr>              <tr>               <td>                 <p align="center"><u>(每一個符合的檢定變項組合重複描述)</u></p>                  <p>最後，<u>數理能力</u>與<u>美術能力</u>的相關係數為<u>0.164</u>、<u>美術能力</u>與<u>比賽總成績</u>的相關係數為<u>0.241</u>，二者為<u>低度相關</u>。表示兩兩變項之間沒有明顯的線性相關。</p>               </td>             </tr>           </tbody></table>       </td>     </tr>   </tbody></table>

<h4>學習單 / Worksheets</h4>
  
<p>[[IMG</p>
    
    <p>本單元包含了以下的學習單，請搭配課程投影片一起練習吧。</p>

    <ul><li><a href="" target="_blank">[[[Google Doc</a></li></ul>

    <h4>測驗 / Examine</h4>
    
    <p>[[IMG</p>
    
    <p>本單元整理了一份測驗，供同學驗證所學：</p>
    ...
    <ul><li><a href="" target="_blank">[[[Google Spreadsheet</a></li></ul>

    <h4>線上操作平臺 / Online Workplace</h4>  

    <p>
<a href="https://lh3.googleusercontent.com/-Ee2TDNZT8fI/Waz_d00_QQI/AAAAAAADRIs/Ypnpepb7hVAw2BWLsRw1IH1lrRcn41YRQCHMYCw/s1600-h/google_drive%255B5%255D"><img alt="google_drive" border="0" height="150" src="https://lh3.googleusercontent.com/-9-z6z_oP0kE/Waz_fvo929I/AAAAAAADRIw/XTbMyCVqaH87ENY_ced_o4myhcMFY-7owCHMYCw/google_drive_thumb%255B3%255D?imgmax=800" style="border: 0px currentcolor; border-image: none; display: inline; background-image: none;" title="google_drive" width="150" /></a>
<a href="https://lh3.googleusercontent.com/-OfWdRncm0Ww/Waz_hxMQZYI/AAAAAAADRI0/V7ec09UcAIwUyUTO_XhKvaMfUI3SCQ5xACHMYCw/s1600-h/Alecive-Flatwoken-Apps-Google-Drive-Forms%255B5%255D"><img alt="Alecive-Flatwoken-Apps-Google-Drive-Forms" border="0" height="150" src="https://lh3.googleusercontent.com/-tNQgkexmgjI/Waz_j7JKfKI/AAAAAAADRI4/akaHW7ubSy0YQDrZU-AgF_fTcPv5e_QggCHMYCw/Alecive-Flatwoken-Apps-Google-Drive-Forms_thumb%255B3%255D?imgmax=800" style="border: 0px currentcolor; border-image: none; display: inline; background-image: none;" title="Alecive-Flatwoken-Apps-Google-Drive-Forms" width="150" /></a>
</p>  
<p>以上的實作不需用到本機端的軟體&#65292;全部使用以下雲端服務&#12290;建議使用<a href="https://www.google.com.tw/chrome/browser/desktop/index.html">Google Chrome瀏覽器</a>開啟&#65306;</p>  <ul>   <li><a href="https://docs.google.com/spreadsheets/">Google試算表</a> (<a href="https://drive.google.com/drive/">Google雲端硬碟</a>)</li>    
 </ul>

    <h4>計算器 / Calculator</h4>  

    <p>[[[IFRAME</p>

<ul>
    <li><a href="" target="_blank">開啟新視窗</a></li>
    <li><a href="" target="_blank">GitHub儲存庫</a></li>
</ul>
